...
- **docs: the user docs describe the browser app, and the F401 as a board option.** Screenshots
  recaptured against a real board; `dev-docs/api.md` is replaced by `dev-docs/protocol.md`.
